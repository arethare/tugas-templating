                           ...
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                 ...
                                 <div class="msg_list_main">
                                    <ul class="msg_list">
                                       <li>
                                          <span><img src="{{ asset('pluto/images/layout_img/msg2.png') }}" class="img-responsive" alt="#" /></span>
                                          <span>
                                       ...
                                       <li>
                                          <span><img src="{{ asset('pluto/images/layout_img/msg3.png') }}" class="img-responsive" alt="#" /></span>
                                          <span>
